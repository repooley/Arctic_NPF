...
plot_curtain(RH_w_bin_medians, common_lat_bin_edges, common_ptemp_bin_edges, vmin=1, vmax=105,
    title=f"Relative Humidity w.r.t. Water - {flight.replace('Flight', 'Flight ')}", cbar_label="% Relative Humidity")
...
plot_curtain(RH_i_bin_medians, common_lat_bin_edges, common_ptemp_bin_edges, vmin=1, vmax=105,
    title=f"Relative Humidity w.r.t. Ice - {flight.replace('Flight', 'Flight ')}", cbar_label="% Relative Humidity")
...
plot_curtain(probe_RH_medians, common_lat_bin_edges, common_ptemp_bin_edges, vmin=1, vmax=105,
    title=f"Probe Relative Humidity - {flight.replace('Flight', 'Flight ')}", cbar_label="% Relative Humidity")
...
plot_curtain(temp_bin_medians,  common_lat_bin_edges, common_ptemp_bin_edges, vmin=210, vmax=310,
    title=f"Absolute Temperature - {flight.replace('Flight', 'Flight ')}", cbar_label='Temperature (K)')
