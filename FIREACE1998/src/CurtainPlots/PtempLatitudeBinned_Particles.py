...
##--Select flight to analyze (Flight1 thru Flight18)--##
flight = "Flight10"
...
plot_curtain(CPC3_bin_medians, common_lat_bin_edges, common_ptemp_bin_edges, vmin=1, vmax=2000,
    title=f"Particles >2.5 nm Abundance - {flight.replace('Flight', 'Flight ')}", cbar_label="Particles >2.5 nm $(Counts/cm^{3})$")
...
plot_curtain(CPC10_bin_medians, common_lat_bin_edges, common_ptemp_bin_edges, vmin=1, vmax=2000,
    title=f"Particles >10 nm Abundance - {flight.replace('Flight', 'Flight ')}", cbar_label="Particles >10 nm $(Counts/cm^{3})$")
...
plot_curtain(nuc_bin_medians, common_lat_bin_edges, common_ptemp_bin_edges, vmin=1, vmax=2000,
    title=f"2.5-10 nm Particle Abundance - {flight.replace('Flight', 'Flight ')}", cbar_label="2.5-10 nm Particles $(Counts/cm^{3})$")
...
plot_curtain(n_10_130_bin_medians, common_lat_bin_edges, common_ptemp_bin_edges, vmin=1, vmax=2000,
    title=f"10-130 nm Particle Abundance - {flight.replace('Flight', 'Flight ')}", cbar_label='10-130 nm Particles $(Counts/cm^{3})$')

##--Plot for total count--##
plot_curtain(total_bin_medians, common_lat_bin_edges, common_ptemp_bin_edges, vmin=1, vmax=2000,
    title=f"Total Particle Abundance - {flight.replace('Flight', 'Flight ')}", cbar_label='All Particles $(Counts/cm^{3})$')
