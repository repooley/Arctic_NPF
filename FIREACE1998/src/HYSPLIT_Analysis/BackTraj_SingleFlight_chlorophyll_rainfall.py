# -*- coding: utf-8 -*-
"""
Created on Thu Nov 20 14:20:12 2025
...
#output_path = r"C:\Users\repooley\REP_PhD\Arctic_NPF\FIREACE\data\processed\HYSPLIT"
...
chlorophyll_file = find_files(directory, flight, "Chlorophyll", "SEASTAR")[0]

##--Pull mixdepth data from files--##
...
fig.suptitle(f"FIRE-ACE {flight.replace('Flight', 'Flight ')} ({flight_date}) HYSPLIT Back Trajectories", 
