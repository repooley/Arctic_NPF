# -*- coding: utf-8 -*-
"""
Created on Thu Nov 20 12:57:48 2025
...
parent_output_dir = r"C:\Users\repooley\REP_PhD\Arctic_NPF\FIREACE1998\data\processed"
...
for flight in flights_to_analyze: 
    ...
    if flight == "Flight2":
        ...
        hspace = -0.15
        htitle=0.85
    elif flight == "Flight16":
        map_extent = [-180, 120, 30, 90]
        hspace = -0.15
        htitle=0.85 
    elif flight == "Flight17":
        map_extent = [-180, 120, 30, 90]
        hspace = -0.15
        htitle=0.85  
    ...
    fig.suptitle(f"FIRE-ACE {flight.replace('Flight', 'Flight ')} HYSPLIT Back Trajectories", 
    ...
    for i, (file, row) in enumerate(zip(sorted(os.listdir(flight_directory)), FIREACE_subset.itertuples(index=False))):
