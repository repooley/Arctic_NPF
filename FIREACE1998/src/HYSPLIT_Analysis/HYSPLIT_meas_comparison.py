# -*- coding: utf-8 -*-
"""
Created on Fri Jan 23 10:59:03 2026
...
flight_times = FIREACE[FIREACE['Flight_num'].isin(flights_to_analyze)]
...
FIREACE_subset = flight_times[flight_times['Time_start'].isin(UTCs)]
...
for flight in flights_to_analyze:
    ...
    flight_rows = FIREACE_subset[FIREACE_subset['Flight_num'] == flight].copy()
