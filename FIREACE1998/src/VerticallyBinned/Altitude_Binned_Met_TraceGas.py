...
for flight in flights_to_analyze:
    ...
    CO2_data = data['CO2'] # just labeled as 'mv' but there's clear pressure dependence
    H2O_data = data['H2O'] # 'mv'
    ...
    ##--Base output path in directory--##
    output_path = r"C:\Users\repooley\REP_PhD\Arctic_NPF\NETCARE2015\data\processed\AltitudeBinnedData\Meteorological"
