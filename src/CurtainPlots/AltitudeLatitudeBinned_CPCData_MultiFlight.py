...
CPC3_bin_medians, _, _, _ = binned_statistic_2d(
    all_latitudes_CPC3, all_altitudes_CPC3, all_CPC3_concs, statistic="mean", bins=[lat_bin_edges_CPC3, alt_bin_edges_CPC3]
)
...
CPC10_bin_medians, _, _, _ = binned_statistic_2d(
    all_latitudes_CPC10, all_altitudes_CPC10, all_CPC10_concs, statistic="mean", bins=[lat_bin_edges_CPC10, alt_bin_edges_CPC10]
)
...
nuc_bin_medians, _, _, _ = binned_statistic_2d(
    all_latitudes_nuc, all_altitudes_nuc, all_nuc_particles, statistic="mean", bins=[lat_bin_edges_nuc, alt_bin_edges_nuc]
)
...
##--Plot for CPC3--##
plot_curtain(
    CPC3_bin_medians, lat_bin_edges_CPC3, alt_bin_edges_CPC3, vmin=0, vmax=3000,
    title="Particles >2.5 nm Abundance",
    cbar_label="Particles >2.5 nm $(Counts/cm^{3})$",
    output_path=r"C:\Users\repooley\REP_PhD\NETCARE2015\data\processed\CurtainPlots\CPC3\Alt_MultiFlights.png"

)

##--Plot for CPC10--##
plot_curtain(
    CPC10_bin_medians, lat_bin_edges_CPC10, alt_bin_edges_CPC10, vmin=0, vmax=3000,
    title="Particles >10 nm Abundance",
    cbar_label="Particles >10 nm $(Counts/cm^{3})$",
    output_path=r"C:\Users\repooley\REP_PhD\NETCARE2015\data\processed\CurtainPlots\CPC10\Alt_MultiFlights.png"
)
 
##--Plot for nucleating particles--##
plot_curtain(
    nuc_bin_medians, lat_bin_edges_nuc, alt_bin_edges_nuc, vmin=0, vmax=1500,
    title="2.5-10 nm Particle Abundance",
    cbar_label="2.5-10 nm Particles $(Counts/cm^{3})$",
    output_path=r"C:\Users\repooley\REP_PhD\NETCARE2015\data\processed\CurtainPlots\Nucleating\Alt_MultiFlights.png"
)
