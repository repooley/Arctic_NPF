# -*- coding: utf-8 -*-
"""
Created on Wed Jan 21 13:10:49 2026
...
for flight in flights_to_analyze:
    ...
    latitude = dataset.data['G_LAT'] # in deg N
    ...
    df = pd.DataFrame({'Altitude': altitude, 'nucleating': nucleating, 
                       'aitken': aitken, 'latitude': latitude, 
    ...
    axs[0].plot(binned_df['nuc_particles_center'], binned_df['Altitude_center'], color='maroon')
    ...
    axs[0].fill_betweenx(binned_df['Altitude_center'], binned_df['nuc_particles_25th'],
    ...
    axs[1].plot(binned_df['aitken_particles_center'], binned_df['Altitude_center'], color='maroon')
    ##--Range is given by filling between data minimum and maximum for each bin--##
    ...
    axs[1].fill_betweenx(binned_df['Altitude_center'], binned_df['aitken_particles_25th'],
