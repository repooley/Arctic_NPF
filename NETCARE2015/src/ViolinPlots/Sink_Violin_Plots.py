...
for flight in flights_to_analyze:
    ...
    if above_dome==True: 
        ax.set(title=f"Condensation Sink - {flight.replace('Flight', 'Flight ')} ({flight_date}) Above the Polar Dome")
    else: 
        ax.set(title=f"Condensation Sink - {flight.replace('Flight', 'Flight ')} ({flight_date})")
    ...
    if above_dome ==True: 
        ax.set(title=f"Coagulation Sink - {flight.replace('Flight', 'Flight ')} ({flight_date}) Above the Polar Dome")
    else: 
        ax.set(title=f"Coagulation Sink - {flight.replace('Flight', 'Flight ')} ({flight_date})")
    ...
    if above_dome==True: 
        ax.set(title=f"rBC Abundance - {flight.replace('Flight', 'Flight ')} ({flight_date}) Above the Polar Dome")
    else:
        ax.set(title=f"rBC Abundance - {flight.replace('Flight', 'Flight ')} ({flight_date})")
