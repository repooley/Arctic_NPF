...
for flight in flights_to_analyze:
    ...
    if above_dome==True: 
        ax.set(title=f"CO - {flight.replace('Flight', 'Flight ')} ({flight_date}) Above the Polar Dome")
    else: 
        ax.set(title=f"CO - {flight.replace('Flight', 'Flight ')} ({flight_date})")
    ...
    if above_dome==True: 
        ax.set(title=f"O\u2083 - {flight.replace('Flight', 'Flight ')} ({flight_date}) Above the Polar Dome")
    else: 
        ax.set(title=f"O\u2083 - {flight.replace('Flight', 'Flight ')} ({flight_date})")
    ...
    if above_dome==True:
        ax.set(title=f"CO/CO\u2082 ratio - {flight.replace('Flight', 'Flight ')} ({flight_date}) Above the Polar Dome")
    else:
        ax.set(title=f"CO/CO\u2082 ratio - {flight.replace('Flight', 'Flight ')} ({flight_date})")
