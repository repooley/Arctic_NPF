...
for flight in flights_to_analyze:
    ...
    ax1.set_title(f"Particles >2.5 nm Abundance - {flight.replace('Flight', 'Flight ')} ({flight_date})", fontsize=18)
    ...
    ax2.set_title(f"Particles >10 nm Abundance - {flight.replace('Flight', 'Flight ')} ({flight_date})", fontsize=18)
    ...
    ##--Add colorbar--##
    cb5 = fig5.colorbar(BC_plot, ax=ax5)
    cb5.minorticks_on()
    ...
    ax5.set_title(f"rBC Particle Abundance - {flight.replace('Flight', 'Flight ')} ({flight_date})", fontsize=18)
