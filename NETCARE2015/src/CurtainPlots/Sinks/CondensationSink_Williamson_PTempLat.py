...
nuc_particles = np.where(nuc_particles >= 0, nuc_particles, np.nan) # num/cm^3
...
Coagulation_df = pd.DataFrame({'PTemp': potential_temp, 'Latitude': latitude, 
                               'Coagulation': coagulation_sink['Coagulation']})
