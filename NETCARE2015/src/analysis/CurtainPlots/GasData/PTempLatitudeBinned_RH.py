...
output_path = r"C:\Users\repooley\REP_PhD\Arctic_NPF\NETCARE2015\data\processed\CurtainPlots\Meteorological\PTempLatitude"
...
for flight in flights_to_analyze:
    ...
    ax1.set_title(f"Relative Humidity wrt Water - {flight.replace('Flight', 'Flight ')} ({flight_date})", fontsize=18)
    ...
    ax2.set_title(f"Relative Humidity wrt Ice - {flight.replace('Flight', 'Flight ')} ({flight_date})", fontsize=18)
    ...
    ax3.set_title(f"Absolute Temperature - {flight.replace('Flight', 'Flight ')} ({flight_date})", fontsize=18)
    ...
    ax1.set_title(f"Relative Humidity wrt Water Counts per Bin - {flight.replace('Flight', 'Flight ')} ({flight_date})")
    ...
    ax2.set_title(f"Relative Humidity wrt Ice Counts per Bin - {flight.replace('Flight', 'Flight ')} ({flight_date})")
