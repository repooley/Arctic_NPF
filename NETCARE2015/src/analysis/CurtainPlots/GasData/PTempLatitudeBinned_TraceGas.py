...
for flight in flights_to_analyze:
    ...
    ax1.set_title(f"O\u2083 Mixing Ratio - {flight.replace('Flight', 'Flight ')} ({flight_date})", fontsize=18)
    ...
    ax2.set_title(f"CO Mixing Ratio - {flight.replace('Flight', 'Flight ')} ({flight_date})", fontsize=18)
    ...
    ax3.set_title(f"CO\u2082 Mixing Ratio - {flight.replace('Flight', 'Flight ')} ({flight_date})", fontsize=18)
    ...
    ax1.set_ylabel('Potential Temperature \u0398 (K)', fontsize=16)
    ax1.tick_params(axis='both', labelsize=16)
    ax1.set_title(f"O\u2083 Counts per Bin - {flight.replace('Flight', 'Flight ')} ({flight_date})", fontsize=18)
    #ax1.set_ylim(238, 301)
    ...
    ax2.set_ylabel('Potential Temperature \u0398 (K)', fontsize=16)
    ax2.tick_params(axis='both', labelsize=16)
    ax2.set_title(f"CO Counts per Bin - {flight.replace('Flight', 'Flight ')} ({flight_date})", fontsize=18)
    #ax2.set_ylim(238, 301)
    ...
    ax3.set_ylabel('Potential Temperature \u0398 (K)', fontsize=16)
    ax3.tick_params(axis='both', labelsize=16)
    ax3.set_title(f"CO\u2082 Counts per Bin - {flight.replace('Flight', 'Flight ')} ({flight_date})", fontsize=18)
    #ax3.set_ylim(238, 301)
