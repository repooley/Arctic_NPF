# -*- coding: utf-8 -*-
"""
Created on Wed Jan 21 10:17:52 2026
...
for i, flight in enumerate(flights_to_analyze):
    ...
    ##--UHSAS total (60+ nm)--##
    axs[0].plot(binned_df["UHSAS_total_center"], binned_df["PTemp_center"],
    ...
    ##--Aitken--##
    axs[2].plot(binned_df["n_10_60_center"], binned_df["PTemp_center"],
                label=flight, color=color)
