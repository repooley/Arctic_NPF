# -*- coding: utf-8 -*-
"""
Created on Thu Jan 15 12:08:22 2026
...
for flight in flights_to_analyze:
    ...
    axs[0].plot(binned_df['UHSAS_total_center'], binned_df['Altitude_center'], color='maroon')
    ##--Range is given by filling between data minimum and maximum for each bin--##
    axs[0].fill_betweenx(binned_df['Altitude_center'], binned_df['UHSAS_total_min'], 
                         binned_df['UHSAS_total_max'], color='indianred', alpha=0.25)
    axs[0].fill_betweenx(binned_df['Altitude_center'], binned_df['UHSAS_total_25th'],
    ...
    axs[1].plot(binned_df['CPC10_conc_center'], binned_df['Altitude_center'], color='saddlebrown')
    axs[1].fill_betweenx(binned_df['Altitude_center'], binned_df['CPC10_conc_min'], 
                         binned_df['CPC10_conc_max'], color='sandybrown', alpha=0.25)
    axs[1].fill_betweenx(binned_df['Altitude_center'], binned_df['CPC10_conc_25th'],
    ...
    axs[2].plot(binned_df['n_10_60_center'], binned_df['Altitude_center'], color='darkcyan')
    axs[2].fill_betweenx(binned_df['Altitude_center'], binned_df['n_10_60_min'], 
                         binned_df['n_10_60_max'], color='turquoise', alpha=0.25)
    axs[2].fill_betweenx(binned_df['Altitude_center'], binned_df['n_10_60_25th'],
                        binned_df['n_10_60_75th'], color='mediumturquoise', alpha=1)
    
    ##--Plot uncertainty as its own trace--##
    axs[2].plot(binned_df['aitken_error_center'], binned_df['Altitude_center'], color='crimson', 
