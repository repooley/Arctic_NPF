# -*- coding: utf-8 -*-
"""
Created on Wed Jan 21 09:47:26 2026
...
for flight in flights_to_analyze:
    ...
    df = pd.DataFrame({'Altitude': altitude, 'temp': temperature, 'pressure': pressure, 'RH': RH})
    ...
    axs[0].plot(binned_df['temp_center'], binned_df['Altitude_center'], color='maroon')
    ##--Range is given by filling between data minimum and maximum for each bin--##
    axs[0].fill_betweenx(binned_df['Altitude_center'], binned_df['temp_min'], 
                         binned_df['temp_max'], color='indianred', alpha=0.25)
    axs[0].fill_betweenx(binned_df['Altitude_center'], binned_df['temp_25th'],
    ...
    axs[1].plot(binned_df['RH_center'], binned_df['Altitude_center'], color='saddlebrown')
    axs[1].fill_betweenx(binned_df['Altitude_center'], binned_df['RH_min'], 
                         binned_df['RH_max'], color='sandybrown', alpha=0.25)
    axs[1].fill_betweenx(binned_df['Altitude_center'], binned_df['RH_25th'],
