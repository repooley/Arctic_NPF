# -*- coding: utf-8 -*-
"""
Created on Tue Jan 27 10:11:30 2026
...
for flight in flights_to_analyze:
    ...
    grow_dfs.append(grow_df[['ptemp', 'Latitude', 'n_10_60']])
    total_dfs.append(total_df[['ptemp', 'Latitude', 'total_count']])
...
total_bin_medians, _, _, _ = binned_statistic_2d(all_latitudes_total, all_ptemps_total, 
    all_total_particles, statistic="median", bins=[lat_bin_edges_total,ptemp_bin_edges_total])
...
def plot_curtain(bin_medians, x_edges, y_edges, vmin, vmax, title, cbar_label):
    ...
    ax.set_ylabel("Potential Temperature (K)", fontsize=12)
    ax.set_title(title)
    #ax.set_ylim(0, 6250)
...
##--Plot for CPC10--##
plot_curtain(CPC10_bin_medians, lat_bin_edges_CPC10, ptemp_bin_edges_CPC10, vmin=0, vmax=1000,
...
plot_curtain(total_bin_medians, lat_bin_edges_total, ptemp_bin_edges_total, vmin=0, vmax=1000,
...
plot_curtain(CPC10_bin_counts, lat_bin_edges_CPC10, ptemp_bin_edges_CPC10, vmin=1, vmax=7500,  
