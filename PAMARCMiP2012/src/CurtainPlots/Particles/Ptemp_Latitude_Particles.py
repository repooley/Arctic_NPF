# -*- coding: utf-8 -*-
"""
Created on Tue Jan 27 09:35:42 2026
...
for flight in flights_to_analyze:
    ...
    common_alt_bin_edges = np.linspace(ptemp_min, ptemp_max, num_bins_ptemp + 1)
    
    ##--Make 2D histograms using common bins--##
    ##--CPC10--##
    CPC10_bin_medians, _, _, _ = binned_statistic_2d(CPC10_df['Latitude'], 
        CPC10_df['ptemp'], CPC10_df['CPC10_conc'], statistic='median', bins=[common_lat_bin_edges, common_alt_bin_edges])
    
    ##--N(10-60)--##
    grow_bin_medians, _, _, _ = binned_statistic_2d(grow_df['Latitude'],
        grow_df['ptemp'], grow_df['n_10_60'], statistic='median', 
